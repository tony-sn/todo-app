  ...
  if (isEditing) {
    ...
    taskContent = (
      <input
        ...
        readOnly
        value={task.text}
        className="relative cursor-default pl-8 min-w-0 flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-white sm:text-sm sm:leading-6"
      />
    );
  }
  return (
